...
HD_PWD='/home/mitsuaki/unsw/18s1/cs4601/imageCompression/designprojectb/WavletVHDL/imagecompression/imagecompression.tmp/axi_ip_demo_v7_10_project/axi_ip_demo_v7_10_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ip_demo_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ip_demo_v1_0.tcl
