...
HD_PWD='c:/users/ryan/desktop/wavletvhdl/imagecompression/imagecompression.tmp/axi_ip_demo_v4_0_project/axi_ip_demo_v4_0_project.runs/floating_point_0_synth_1'
cd "$HD_PWD"
