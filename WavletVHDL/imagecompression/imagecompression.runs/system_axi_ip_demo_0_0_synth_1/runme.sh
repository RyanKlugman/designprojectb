...
HD_PWD='/home/mitsuaki/unsw/18s1/cs4601/imageCompression/designprojectb/WavletVHDL/imagecompression/imagecompression.runs/system_axi_ip_demo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_ip_demo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_ip_demo_0_0.tcl
