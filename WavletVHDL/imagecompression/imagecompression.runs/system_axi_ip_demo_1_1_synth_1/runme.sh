...
HD_PWD='C:/Users/Kevin/Documents/COMP4601/WavletVHDL/imagecompression/imagecompression.runs/system_axi_ip_demo_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_ip_demo_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_ip_demo_1_1.tcl
