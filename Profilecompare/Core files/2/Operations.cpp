...
unsigned char *Quantize(float *input, int img_size, int amount, wlt_header_info &wlt, int acceleration)
{
  ...
  //    	registers6[4] = do_scale;
		...
		for(int r = 0; r < image_height;r+=2) { 
			...
			while (registers1[5] == 0){ //polling for done
				c++;	
			}
			...
			// while (registers2[5] == 0){ //polling for done
			// 	c++;	
			// }
			...
			// while (registers3[5] == 0){ //polling for done
			// 	c++;	
			// }
			...
			// while (registers4[5] == 0){ //polling for done
			// 	c++;	
			// }
			...
			// while (registers5[5] == 0){ //polling for done
			// 	c++;	
			// }
			...
			// while (registers6[5] == 0){ //polling for done
			// 	c++;	
			// }
			...
			// while (registers7[5] == 0){ //polling for done
			// 	c++;	
			// }
